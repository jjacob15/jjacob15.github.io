...
var _menuContent = __webpack_require__(/*! ../constants/menuContent */ "./src/constants/menuContent.js");
...
function setLandingMenu(items) {
  return function (dispatch) {
    if (items === undefined) {
      var defaultItems = _menuContent2.default.quickLinks.content[0].content.map(function (x) {
...
module.exports = { onLandingMenuSelected: onLandingMenuSelected, setLandingMenu: setLandingMenu };
  ...
  switch (item.source) {
    case _iapplyApps.LANDING:
      return function (dispatch, getState) {
        ...
        if (currentItem === item.id) return void 0;

        //if iapply
        if (item.id === 7) {
          dispatch({ type: _types.SET_MENU, content: _menuContent2.default.iapply });
          dispatch({ type: _types.SET_LANDING_MENU });
...
function onSideBarMenuBack(item) {
  return function (dispatch) {
    dispatch({ type: _types.SET_MENU, content: _menuContent2.default[item] });
...
function onSideBarMenuSelected(item) {
  return function (dispatch, getState) {
    ...
    if (item) {
      var state = getState();
      _menuContent2.default[state.nav.menu.id].selected = item;
    }
...
module.exports = { onSideBarMenuSelected: onSideBarMenuSelected, onSideBarMenuBack: onSideBarMenuBack };
...
var Container = function (_React$Component) {
  ...
  _createClass(Container, [{
    ...
    value: function render() {
      ...
      if (nav.landingMenu.selected) {
        switch (nav.landingMenu.selected.id) {
          case 5:
      ...
      } else return _react2.default.createElement(_iapply2.default, this.props);
    }
  }]);
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'container-fluid' },
                _react2.default.createElement(_TabContainer2.default, this.props),
                _react2.default.createElement(
                  'div',
                  { className: 'row' },
                  _react2.default.createElement(
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'span',
        null,
        nav.landingMenu.content && _react2.default.createElement(
          'ul',
...
var SideBarContent = function (_Component) {
  ...
  _createClass(SideBarContent, [{
    ...
    key: 'renderNavLabel',
    value: function renderNavLabel(label) {
...
function actions(dispatch) {
  return {
    ...
    handleMenuBack: function handleMenuBack(item) {
      return dispatch((0, _actions.onSideBarMenuBack)(item));
    }
  };
}
...
var initialState = {
  ...
  menu: _menuContent2.default.main,
  landingMenu: {
    selected: {},
    content: [],
    context: null
